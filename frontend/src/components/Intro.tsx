...
// --- THEME SETUP ---
// Using Caveat for that hand-drawn look that supports Latin-ext and Cyrillic
...
// Helper for HStack since we are in one file
function HStack({ children, spacing, ...props }: { children: React.ReactNode; spacing: number | string; [key: string]: any }) {
    return (
        <Box display="flex" flexDirection="row" gap={spacing} {...props}>
            {children}
        </Box>
    );
}